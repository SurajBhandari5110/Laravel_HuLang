...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="sidebar main-content">
            ...
            <div class="poss-contents">
                @foreach ($posts as $post)
                    <div class="post">
                        <div class="post-header">
                            <img src="{{ asset('images/default-profile.png') }}" alt="Profile" class="post-profile-pic">
                            <div>
    ...
    <script>
        ...
        const postsContainer = document.querySelector('.poss-contents');
        ...
        submitPostBtn.addEventListener('click', () => {
            ...
            .then(data => {
                ...
                // Prepend to posts container (newest first)
